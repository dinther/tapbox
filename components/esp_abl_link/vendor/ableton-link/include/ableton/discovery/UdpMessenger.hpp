...
private:
  struct Impl : std::enable_shared_from_this<Impl>
  {
                    ...
                    const It messageEnd)
    {
      ...
      {
        // tapbox patch: upstream Ableton/link commit d466f42 (2026-03-05)
        // removed the hardcoded /24 subnet filter that was here — it dropped
        // discovery messages from peers outside the interface's /24, which
        // breaks link-local (169.254/16) direct-cable sessions.
